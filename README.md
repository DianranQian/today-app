...
| 子应用 | 说明 |
|---|---|
| 🍜 **今天吃什么** | 随机推荐菜谱（老虎机滚动动画），400+ 家常菜 + 75 种饮品，按季节优先、避免近期重复，支持忌口设置、自定义/文件导入菜谱 |
| 📍 **今天去哪** | 随机推荐去处（65 个内置：吃饭/逛街/公园/文化/运动/夜生活），可按类型、预算筛选 |
